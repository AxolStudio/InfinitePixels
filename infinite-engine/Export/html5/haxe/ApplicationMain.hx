...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("InfiniteEngine", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("InfiniteEngine", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.sample.infiniteengine";
		...
		#elseif air
		app.window.title = "InfiniteEngine";
		#else
